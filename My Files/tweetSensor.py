...
for tweet in twitter_search:
  ...
  "object": {
    ...
    if 'type' in response['docSentiment'] and not None:
        ...
        # print type(tweet_sentiment_score)
        # tweet_sentiment_score_str = str(tweet_sentiment_score)
        # print type(tweet_sentiment_score_str)
        # tweet_sentiment_score_int = float(tweet_sentiment_score_str)
        # print type(tweet_sentiment_score_int)
        # tweet_sentiment_score_abs = abs(tweet_sentiment_score_int)
        # print type(tweet_sentiment_score_abs)
        # tweet_sentiment_score_abs_str = str(tweet_sentiment_score_abs)
        # print type(tweet_sentiment_score_abs_str)
        # tweet_sentiment_score_int = int(response['docSentiment']['score'])
        # tweet_sentiment_score = round(tweet_sentiment_score_int, 2)
        tweet_sentiment_type = response['docSentiment']['type']
        tweet_sentiment_score_a = abs(tweet_sentiment_score)
        print tweet_sentiment_score_a
        if (tweet_sentiment_score) > 0:
            tweet_sentiment_color = "rgba(0,255,0," + str(tweet_sentiment_score_a) + ")"
            print 'green'
            print tweet_sentiment_color
        else: 
